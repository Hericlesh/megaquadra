...
import './Regulamento.css'; // Ensure CSS is imported
    ...
    <div className="regulamento-container">
      ...
      <table className="lotto-table">
        <thead>
          ...
          <tr>
            <td>A validade é nessa sequencia</td>
            <td>A validade é nessa sequencia</td>
            <td>A validade é nessa sequencia</td>
            <td>A validade é nessa sequencia</td>
            <td>A validade é nessa sequencia</td>
        ...
        <tbody>
          <tr>
            <td>As dezenas finais dos 1ª,2ª, 3ª e 4ª</td>
            <td>As dezenas finais dos 2ª,3ª,4ª e 5ª</td>
            <td>As dezenas finais dos 3ª,4ª,5ª e 1ª</td>
            <td>As dezenas finais dos 4ª,5ª,1ª e 2ª</td>
            <td>As dezenas finais dos  5ª,1ª,2ª e 3ª</td>
            <td>As dezenas finais dos  1ª,3ª,4ª e 5ª</td>
          </tr>
          <tr>
            <td>1ª PRÊMIO 4 7 1 4 <span className="highlight-number">43</span></td>
            <td>2ª PRÊMIO 3 6 1 6 <span className="highlight-number">67</span></td>
            <td>3ª PRÊMIO 0 2 3 3 <span className="highlight-number">35</span></td>
            <td>4ª PRÊMIO 5 0 87 <span className="highlight-number">78</span></td>
          ...
          <tr>
            <td>2ª PRÊMIO 3 6 1 6 <span className="highlight-number">67</span></td>
            <td>3ª PRÊMIO 0 2 3 3 <span className="highlight-number">35</span></td>
            <td>4ª PRÊMIO 5 0 8 7 <span className="highlight-number">78</span></td>
            <td>5ª PRÊMIO 3 0 4 0 <span className="highlight-number">06</span></td>
            <td>1ª PRÊMIO 4 7 1 4 <span className="highlight-number">43</span></td>
            <td>3ª PRÊMIO 0 2 3 3 <span className="highlight-number">35</span></td>
          </tr>
          ...
          <div className="dezena-table">
            <div className="dezena-row">
              <div className="dezena-column">
                <span className="dezena-header">DEZENA DO 1º PRÊMIO</span>
                <span className="dezena-value">43</span>
              </div>
              <div className="dezena-column">
                <span className="dezena-header">DEZENA DO 2º PRÊMIO</span>
                <span className="dezena-value">67</span>
              </div>
              <div className="dezena-column">
                <span className="dezena-header">DEZENA DO 3º PRÊMIO</span>
                <span className="dezena-value">35</span>
              </div>
              <div className="dezena-column">
                <span className="dezena-header">DEZENA DO 4º PRÊMIO</span>
                <span className="dezena-value">78</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="prize-result">
          ...
          <div className="dezena-table">
            <div className="dezena-row">
              ...
              <div className="dezena-column">
                <span className="dezena-header">DEZENAS DO 5º PRÊMIO</span>
                <span className="dezena-value">06</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="prize-result">
          ...
          <div className="dezena-table">
            <div className="dezena-row">
              ...
              <div className="dezena-column">
                <span className="dezena-header">DEZENA DO 5º PRÊMIO</span>
                <span className="dezena-value">06</span>
              </div>
              <div className="dezena-column">
                <span className="dezena-header">DEZENAS DO 1º PRÊMIO</span>
                <span className="dezena-value">43</span>
              </div>
            </div>
          </div>
        ...
        <div className="prize-result">
          ...
          <div className="dezena-table">
            <div className="dezena-row">
              ...
              <div className="dezena-column">
                <span className="dezena-header">DEZENAS DO 2º PRÊMIO</span>
                <span className="dezena-value">67</span>
              </div>
            </div>
          </div>
        ...
        <div className="prize-result">
          ...
          <div className="dezena-table">
            <div className="dezena-row">
              ...
              <div className="dezena-column">
                <span className="dezena-header">DEZENAS DO 3ª PRÊRMIO</span>
                <span className="dezena-value">35</span>
              </div>
            </div>
          </div>
